...
import {container,wrapper,headingGrid,galleryimage,imgbox,transparentbox,caption,opacitylow,} from '../styles/PhotoGallery.module.css';
    ...
    <div className={imgbox}>
      ...
      <div className={transparentbox}>
        <div className={caption}>
          ...
          <p className={opacitylow}>Beach</p>
        </div>
      </div> 
    </div>
    <div className={imgbox}>
